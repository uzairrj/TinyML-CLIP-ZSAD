...
def train_text_adapter(
    ...
    for epoch in range(start_epoch, text_epoch):
        ...
        for input_data in tqdm(train_loader):
            ...
            # forward image
            with torch.no_grad():
                _, patch_features = clip_surgery.encode_image(image, adapted_model.levels)
...
def main():
    ...
    parser.add_argument(
        "--model_name",
        type=str,
        default="TinyCLIP-ViT-39M-16-Text-19M",
        help="clip model to use (default: ViT-L-14-336)",
    )
    parser.add_argument("--img_size", type=int, default=518)
    parser.add_argument("--surgery_until_layer", type=int, default=9)
    ...
    parser.add_argument("--text_epoch", type=int, default=10, help="epochs for stage1")
    parser.add_argument("--image_epoch", type=int, default=50, help="epochs for stage2")
