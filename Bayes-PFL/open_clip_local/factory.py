...
def load_checkpoint(model, checkpoint_path, strict=True):
    ...
    # Remove TinyCLIP prefixes
    for k in list(state_dict.keys()):
        if k.startswith("_image_encoder.module."):
            state_dict[k.replace("_image_encoder.module.", "")] = state_dict.pop(k)
        elif k.startswith("_text_encoder.module."):
            state_dict[k.replace("_text_encoder.module.", "")] = state_dict.pop(k)
        elif k.startswith("_logit_scale.module."):
            state_dict[k.replace("_logit_scale.module.", "")] = state_dict.pop(k)
