...
def main(args):
    ...
    dataset_classes, class_name_index = generate_class_info(kwargs['dataset'])
    ...
    save_metric(metrics, [dataset_classes[class_name_index[kwargs['class_name']]]], kwargs['class_name'],
...
def get_args():
    ...
    parser.add_argument("--backbone", type=str, default="TinyCLIP-ViT-39M-16-Text-19M",
                        choices=['ViT-B-16-plus-240', 'TinyCLIP-ViT-39M-16-Text-19M'])
    parser.add_argument("--pretrained_dataset", type=str, default="yfcc15m")
