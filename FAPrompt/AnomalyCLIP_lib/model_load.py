...
_MODELS = {
    ...
    "TinyCLIP-ViT-39M-16-Text-19M": "https://github.com/wkcn/TinyCLIP-model-zoo/releases/download/checkpoints/TinyCLIP-ViT-39M-16-Text-19M-YFCC15M.pt",
        ...
        try:
            ...
            for k, v in state_dict.items():
                if k.startswith("module."):
                    ...
                    new_state_dict[k.replace("_image_encoder.module.", "")] = v
                elif k.startswith("_text_encoder.module."):
                    new_state_dict[k.replace("_text_encoder.module.", "")] = v
                elif k.startswith("_logit_scale.module."):
                    new_state_dict[k.replace("_logit_scale.module.", "")] = v
