...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default="TinyCLIP-ViT-39M-16-Text-19M",
                        choices=["ViT-B-16", "ViT-B-32", "ViT-L-14", "ViT-L-14-336", "TinyCLIP-ViT-40M-32-Text-19M", "TinyCLIP-ViT-39M-16-Text-19M"],
                        help="The CLIP model to be used (default: 'TinyCLIP-ViT-39M-16-Text-19M')")
    ...
    parser.add_argument("--image_size", type=int, default=512, help="Size of the input images (default: 512)")
