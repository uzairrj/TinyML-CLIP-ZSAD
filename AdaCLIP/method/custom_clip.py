...
_TinyCLIP_ViT40M32_Text19M = dict(
    laion400m=_pcfg("https://github.com/wkcn/TinyCLIP-model-zoo/releases/download/checkpoints/TinyCLIP-ViT-40M-32-Text-19M-LAION400M.pt")
)

_TinyCLIP_ViT39M16_Text19M = dict(
    yfcc15m=_pcfg("https://github.com/wkcn/TinyCLIP-model-zoo/releases/download/checkpoints/TinyCLIP-ViT-39M-16-Text-19M-YFCC15M.pt")
)
...
_PRETRAINED = {
    ...
    "TinyCLIP-ViT-40M-32-Text-19M": _TinyCLIP_ViT40M32_Text19M,
    "TinyCLIP-ViT-39M-16-Text-19M": _TinyCLIP_ViT39M16_Text19M,
}
        ...
        try:
            ...
            for k, v in state_dict.get("state_dict", state_dict).items():
                if k.startswith("module."):
                    sd[k[7:]] = v
                elif k.startswith("_image_encoder.module."):
                    sd[k.replace("_image_encoder.module.", "")] = v
                elif k.startswith("_text_encoder.module."):
                    sd[k.replace("_text_encoder.module.", "")] = v
                elif k.startswith("_logit_scale.module."):
                    sd[k.replace("_logit_scale.module.", "")] = v
...
def create_model(
    ...
    assert pretrained and pretrained.lower() in ('openai', 'laion400m', 'yfcc15m'), 'only support openai, laion400m or yfcc15m module.'
    logging.info(f'Loading pretrained {model_name} from {pretrained}.')
